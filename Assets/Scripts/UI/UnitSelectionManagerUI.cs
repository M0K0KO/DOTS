...
public class UnitSelectionManagerUI : MonoBehaviour
{
    ...
    private void UpdateVisual()
    {
        ...
        float canvsScale = canvas.transform.localScale.x;
        selectionAreaRectTransform.anchoredPosition = new Vector2(selectionAreaRect.x, selectionAreaRect.y) / canvsScale;
        selectionAreaRectTransform.sizeDelta = new Vector2(selectionAreaRect.width, selectionAreaRect.height) / canvsScale;
    }
}
